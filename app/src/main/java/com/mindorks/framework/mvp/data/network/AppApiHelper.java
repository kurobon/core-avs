...
public class AppApiHelper implements ApiHelper {
    ...
    public Observable<LoginResponse> doServerLoginApiCall(LoginRequest.ServerLoginRequest
        ...
        return Rx2AndroidNetworking.post(ApiEndPoint.ENDPOINT_SERVER_LOGIN)
                .addHeaders("U4D-API-KEY", mApiHeader.getPublicApiHeader().getApiKey())
                .addBodyParameter("email", request.getEmail())
    ...
    public Observable<LogoutResponse> doLogoutApiCall() {
        return Rx2AndroidNetworking.post(ApiEndPoint.ENDPOINT_LOGOUT)
                .addHeaders("U4D-API-KEY", mApiHeader.getProtectedApiHeader().getAccessToken())
                .build()
